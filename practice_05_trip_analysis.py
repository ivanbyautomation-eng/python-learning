...
average_distance = total_distance / len(trips)
...
print('\nАнализ рейсов: ')
print(f"Дальних рейсов: {long_trip_count}")
print(f"Обычных рейсов: {regular_trip_count}")
print(f"Среднее расстояние: {average_distance:.2f} км")

print('\nСамый дорогой рейс: ')
print(f"Номер рейса: {most_expensive_trip_number}")
print(f"Водитель: {most_expensive_trip['driver_name']}")
print(f"Стоимость: {most_expensive_trip['fuel_cost']:.2f} руб")